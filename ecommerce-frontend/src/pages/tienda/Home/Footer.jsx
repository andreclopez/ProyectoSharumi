...
const Footer = () => {
  return (
    <Box sx={{ bgcolor: "#5a2a2a", pt: 8, pb: 4 }}> 
      <Container>
        <Grid container spacing={6} alignItems={"flex-start"}>
          ...
          <Grid item xs={12} sm={6} md={2}>
            ...
            {["Preguntas frecuentes", "Envios", "Devoluciones", "Políticas de reembolso", "Contacto"].map((item, idx) => (
              <Link href="#" key={idx} underline="hover" display="block" color="#a0522d">
                {item}
              </Link>
            ))}
          ...
          <Grid item xs={12} sm={12} md={3}>
            ...
            <Typography variant="body2" color="#a0522d" mb={1}>
              Subscribete y mantente informado.
            </Typography>
        ...
        <Divider sx={{ my: 3, borderColor: 'rgba(160, 82, 45, 0.5)' }} /> 

        <Box display="flex" justifyContent="space-between" flexWrap="wrap">
          <Typography variant="body2" color="#a0522d">
            © 2025 Sharumi. Todos los derechos reservados.
          </Typography>
